...
<p>
    <?=Html::link("archiv_turnierliste.php?saison=" . $saison->get_saison_id() . "#liste_liga" , "Liste der Ligaturniere" , false, "reorder")?><br>
    <?=Html::link("archiv_turnierliste.php?saison=" . $saison->get_saison_id() . "#liste_final" , "Liste der Finalturniere" , false, "reorder")?><br>
    <?=Html::link("archiv_turnierliste.php?saison=" . $saison->get_saison_id() . "#ergebnisse_liga" , "Ergebnisse der Ligaturniere" , false, "reorder")?><br>
    <?=Html::link("archiv_turnierliste.php?saison=" . $saison->get_saison_id() . "#ergebnisse_final" , "Ergebnisse der Finalturniere" , false, "reorder")?>
</p>
